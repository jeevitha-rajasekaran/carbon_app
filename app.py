...
def main():
    ...
    <div class="hero-section">
        ...
        <div class="hero-content">
            ...
            <p class="hero-subtitle">
                ...
                <span class="llm-badge">🤖 Smart Analysis</span>
            </p>
    ...
    with footer_col2:
        ...
        <div class="tech-item"><span class="tech-icon icon-animated">⚡</span><span>Instant Recommendations</span></div>
    ...
    <div class="copyright-footer">
        <p class="copyright-text">
            © 2025 CO₂ Reduction Platform | Enhanced with Smart AI Response Engine 🧠
        </p>
    </div>
    """, unsafe_allow_html=True)
